...
Elm.Contact.make = function (_elm) {
   ...
   var fetchContact = $Effects.task($Task.map(Refresh)($Task.toMaybe(A2($Http.get,
   decodeContact,
   "http://localhost:4000/api/contacts/1"))));
